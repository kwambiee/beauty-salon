...
const navBar = () => {
    ...
    return (
      <nav className="fixed inset-0 w-[30%] bg-homeBg bg-cover bg-center-center bg-no-repeat z-20 bg-[#099db3]">
        <div className="pt-[60px] relative box-border h-full w-full z-30">
          ...
          {/* <---- Logo ----> */}
          <div className=" bg-salonLogo bg-cover bg-center-center bg-no-repeat h-[200px] w-[200px] mx-auto from-green-500 to-white rotate-12 -mt-9"></div>
